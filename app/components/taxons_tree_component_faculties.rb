class TaxonsTreeComponentFaculties < ViewComponent::Base
    ...
    def tree(root_taxon:, base_class:, max_level:)
        ...
        content_tag :div, class: "container semi-transparent-un reveal", id: 'de' do
              ...
              link_to(helpers.taxon_seo_url(taxon), class: '') do
                content_tag(:div, class: 'inherit') do
                  ...
                  content_tag(:div, class: 'box-d-2-fa grid') do
                    content_tag(:span, taxon.name, class: 'text-fa black')
                  end
                end
              end +
